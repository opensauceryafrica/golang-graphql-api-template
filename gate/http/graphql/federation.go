	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Address":
			...
			case "findAddressByUserID":
				id0, err := ec.unmarshalNID2string(ctx, rep["user_id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findAddressByUserID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindAddressByUserID(ctx, id0)
				if err != nil {
		...
		case "SecuritySetting":
			resolverName, err := entityResolverNameForSecuritySetting(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "SecuritySetting": %w`, err)
			}
			switch resolverName {
			...
			case "findSecuritySettingByUserID":
				id0, err := ec.unmarshalNID2string(ctx, rep["user_id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findSecuritySettingByUserID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindSecuritySettingByUserID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "SecuritySetting": %w`, err)
				}
		...
		case "Wallet":
			resolverName, err := entityResolverNameForWallet(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Wallet": %w`, err)
			}
			switch resolverName {
			...
			case "findWalletByUserID":
				id0, err := ec.unmarshalNID2string(ctx, rep["user_id"])
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findWalletByUserID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindWalletByUserID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Wallet": %w`, err)
				}
...
func entityResolverNameForAddress(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		...
		return "findAddressByUserID", nil
	}
	return "", fmt.Errorf("%w for Address", ErrTypeNotFound)
}

func entityResolverNameForSecuritySetting(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findSecuritySettingByUserID", nil
	}
	return "", fmt.Errorf("%w for SecuritySetting", ErrTypeNotFound)
}
...
func entityResolverNameForWallet(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
			m   map[string]interface{}
			val interface{}
		...
		return "findWalletByUserID", nil
	}
	return "", fmt.Errorf("%w for Wallet", ErrTypeNotFound)
}
